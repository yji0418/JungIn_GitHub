...
public partial class ID_overlap : System.Web.UI.Page
{
    ...
    {
        String str = @"<script>"+"opener.document.getElementById('ContentPlaceHolder1_TextBox1').value = '" + TextBox1.Text + "'; self.close(); </script>";
