<%@ Page Title="Dr.Self 게시판" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="board_read.aspx.cs" Inherits="board_read" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="auto-style1">
     ...
     <!--하단 버튼-->
        ...
        <asp:Button ID="Button2" runat="server" Text="답글" CssClass="button_submit"/>&nbsp;&nbsp;&nbsp;
