...
public partial class board_write2 : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        String sql2 = @"Insert into Drself_board(name, pwd, title, body, wDate) Values(@name, @pwd, @title, @body, getDate())";
        ...
        String sql3 = @"Update Drself_board Set ref_id = seq Where ref_id = 0";
