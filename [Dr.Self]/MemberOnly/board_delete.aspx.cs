...
public partial class MemberOnly_board_delete : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "Select ref_id from Drself_board Where seq=" + seq;
        ...
        string sql2 = @"Select count(*) From Drself_board Where ref_id=" + refString + " AND deleted != 'Y' ";
        ...
        if (count == 1)
        {
            string sql3 = @"Delete From Drself_board Where ref_id=" + refString;
        ...
        {
            string sql4 = @"Update Drself_board Set deleted='Y' Where seq =" + seq;
