<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Board_Edit.aspx.cs" Inherits="MemberOnly_Board_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
     <!--게시판 문구-->
    <div><p style="font-family:메이플스토리 Light; font-size:30pt; font-weight:700;">자유게시판 글 수정</p></div>
       ...
       <br />
        ...
        <center>
            <div class="input_file">
                <p style="margin-left:-740px;">첨부 파일</p><br />
                    <asp:Label ID="Label1" runat="server" Text="Label" style="font-family:메이플스토리 Light;"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label2" runat="server" Text="Label" style="font-family:메이플스토리 Light;"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton1" runat="server" style="font-family:메이플스토리 Light;" OnClick="LinkButton1_Click">[첨부파일 삭제]</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <!--첨부파일 수정-->
         <center>
            <div class="input_file">
                <p style="margin-left:-740px;">파일 수정</p><br />
                    <asp:FileUpload ID="FileUpload1" runat="server" style=" font-family:메이플스토리 Light;"></asp:FileUpload>*첨부파일이 있을경우 상단의 파일을 먼저 삭제하세요!                
            </div>
        </center>
     ...
     <!--하단 버튼-->
        ...
        <asp:Button ID="Button2" runat="server" Text="수정" CssClass="button_submit" OnClick="Button2_Click"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
